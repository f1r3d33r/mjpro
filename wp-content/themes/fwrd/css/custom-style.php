...
$backup_id = $post_id;
$iron_styles = new Iron_Dynamic_Styles('fwrd');
...
$iron_styles->setBorderColor('.no-touchevents .photo-wrap:hover .tab-circle, .comment-list > li:after, .comment-list .children > li:before, .comment-reply-title', 'text_color_dark');
...
/*$iron_styles->set('.side-menu .logo-desktop', 'max-height', 'push_menu_logo_max_height');*/
...
/*$iron_styles->set('.classic-menu > ul > li.logo a img', 'max-height', 'classic_menu_logo_max_height');*/
...
// Fix Anchor on same page - Override Item Active
$iron_styles->setFont('.home .classic-menu > ul > li.current-menu-item > a', 'classic_menu_typography');

// Fix Anchor on same page - Override Item Hover
...
$secondarycolor2_txtcolor_override = '.color5_txt, .color5_txt p';
$secondarycolor2_bgcolor_override = '.color5_bg';
$iron_styles->setColor($secondarycolor2_txtcolor_override, 'secondary_color_dark');
$iron_styles->setBackgroundColor($secondarycolor2_bgcolor_override, 'secondary_color_dark');
...
echo '.menu-toggle rect{
	fill:' . get_iron_option('menu_open_icon_color') . ';
}';
echo '.menu-toggle-off polygon{
	fill:' . get_iron_option('menu_close_icon_color') . ';
}';