...
<?php	if ( get_field('alb_store_list') ) : ?>
					<div class="buttons-block">
						<div class="release-date"><?php echo esc_html__("Release Date", 'fwrd'); ?>: <span><?php the_field('alb_release_date') ?></span></div>
						
						
						<div class="available-now"><?php echo esc_html__("Available now on", 'fwrd'); ?>:</div>
						<ul class="store-list">
...
<?php	if ( get_field('alb_review') ) : ?>
					<!-- content-box -->
					<section class="content-box">
						<h4><?php esc_html_e('Album Review', 'fwrd'); ?></h4>
