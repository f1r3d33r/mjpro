<?php
require_once(get_template_directory() . '/admin/options/fields/text/field_text.php');
require_once(get_template_directory() . '/admin/options/fields/select/field_select.php');
require_once(get_template_directory() . '/admin/options/fields/color/field_color.php');
	...
	function render() {
		...
		<tr>
			...
			<?php
				...
				echo '<label>'.esc_html__('Text Align', 'fwrd').'</label> ';
			...
			<?php
				...
				echo '<label>'.esc_html__('Font Size', 'fwrd').'</label> ';
		...
		<tr>
			...
			<?php
				...
				echo '<label>'.esc_html__('Transform', 'fwrd').'</label> ';
			...
			<?php
				...
				echo '<label>'.esc_html__('Line Height', 'fwrd').'</label> ';
		...
		<tr>
			...
			<?php
				...
				echo '<label>'.esc_html__('Font Weight', 'fwrd').'</label> ';
		...
		<tr>
			...
			<?php
				...
				echo '<label>'.esc_html__('Font Color', 'fwrd').'</label> ';
			...
			<?php
				...
				echo '<label>'.esc_html__('Background', 'fwrd').'</label> ';
