...
if(function_exists('add_shortcode_param')) {
	...
	vc_add_shortcode_param('post_multiselect', 'vc_setting_field_post_multiselect', IRON_PARENT_URL.'/includes/vc-extend/assets/settings/post_multiselect.js');
	...
	vc_add_shortcode_param('post_select', 'vc_setting_field_post_select', IRON_PARENT_URL.'/includes/vc-extend/assets/settings/post_multiselect.js');
	...
	vc_add_shortcode_param('taxonomy_multiselect', 'vc_setting_field_taxonomy_multiselect', IRON_PARENT_URL.'/includes/vc-extend/assets/settings/post_multiselect.js');
	...
	vc_add_shortcode_param('font_select', 'vc_setting_field_font_select');




	function vc_setting_field_date($settings, $value) {
	...
	vc_add_shortcode_param('date', 'vc_setting_field_date');
