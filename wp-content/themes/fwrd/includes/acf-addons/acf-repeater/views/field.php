		...
		<thead>
			<tr>
				...
				<?php foreach( $field['sub_fields'] as $sub_field ): 
					...
					?>
					<th class="acf-th-<?php echo esc_attr($sub_field['name']); ?> field_key-<?php echo esc_attr($sub_field['key']); ?>" <?php echo esc_attr($attr); ?>>
						<span><?php echo esc_attr($sub_field['label']) . $required_label; ?></span>
