		...
		*/
		...
		public function maybe_disable_plugin() {
			...
			if ( ! $this->meets_requirements() ) {
				...
				echo '<p>' . wp_kses( sprintf( __( 'ACF Widget Area is missing requirements and has been <a href="%s">deactivated</a>. Please make sure all requirements are available.',
				 'acf_widget_area' ), admin_url( 'plugins.php' ) ),iron_get_allowed_html()) . '</p>';
				echo '</div>';
