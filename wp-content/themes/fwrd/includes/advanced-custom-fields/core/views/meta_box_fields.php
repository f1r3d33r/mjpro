			...
			<table class="acf widefat">
				<tr>
					...
					<td class="field_label">
						<strong>
							<a class="acf_edit_field row-title" title="<?php esc_html_e("Edit this Field",'acf'); ?>" href="javascript:;"><?php echo $field['label']; ?></a>
						</strong>
						<div class="row_options">
							...
							<span><a class="acf_delete_field" title="<?php esc_html_e("Delete this Field",'acf'); ?>" href="javascript:;"><?php esc_html_e("Delete",'acf'); ?></a></span>
						</div>
					</td>
