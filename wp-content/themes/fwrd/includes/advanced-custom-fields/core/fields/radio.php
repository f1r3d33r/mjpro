...
class acf_field_radio extends acf_field
{
	...
	*/
	...
	function __construct()
	{
		// vars
		$this->name = 'radio';
		$this->label = esc_html__("Radio Button",'acf');
		...
		<tr class="field_option field_option_<?php echo $this->name; ?>">
			...
			<td>
				...
				do_action('acf/create_field', array(
					...
					'message'	=>	esc_html__("Add 'other' choice to allow for custom values", 'acf')
				));
				...
				do_action('acf/create_field', array(
					...
					'message'	=>	esc_html__("Save 'other' values to the field's choices", 'acf')
				));
		...
		<tr class="field_option field_option_<?php echo $this->name; ?>">
			...
			<td>
				...
				do_action('acf/create_field', array(
					...
					'layout' => 'horizontal', 
					'choices' => array(
						'vertical' => esc_html__("Vertical",'acf'), 
						'horizontal' => esc_html__("Horizontal",'acf')
					)
				));
