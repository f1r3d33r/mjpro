...
class acf_field_textarea extends acf_field
{
	...
	*/
	...
	function __construct()
	{
		// vars
		$this->name = 'textarea';
		$this->label = esc_html__("Text Area",'acf');
		$this->defaults = array(
			'default_value'	=> '',
			'formatting' 	=> 'br',
			'maxlength'		=> '',
...
<tr class="field_option field_option_<?php echo $this->name; ?>">
	<td class="label">
		...
		<p><?php esc_html_e("Effects value on front end",'acf') ?></p>
	</td>
	<td>
		<?php 
		do_action('acf/create_field', array(
			...
			'choices' => array(
				'none'	=>	esc_html__("No formatting",'acf'),
				'br'	=>	esc_html__("Convert new lines into &lt;br /&gt; tags",'acf'),
				'html'	=>	esc_html__("Convert HTML into tags",'acf')
			)
		));
		?>
	</td>
