...
class acf_field_google_map extends acf_field
{
	...
	*/
	...
	function __construct()
	{
		...
		$this->label = esc_html__("Google Map",'acf');
		...
		$this->l10n = array(
			'locating'			=>	esc_html__("Locating",'acf'),
			'browser_support'	=>	esc_html__("Sorry, this browser does not support geolocation",'acf'),
		);
	...
	function create_field( $field )
	{
		...
		<div class="acf-google-map <?php echo esc_attr($o['class']); ?>" <?php echo $atts; ?>>
			...
			<div class="title">
				...
				<div class="has-value">
					<a href="#" class="acf-sprite-remove ir" title="<?php esc_html_e("Clear location",'acf'); ?>">Remove</a>
