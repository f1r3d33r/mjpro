...
class acf_field_file extends acf_field
{
	...
	*/
	...
	function __construct()
	{
		// vars
		$this->name = 'file';
		$this->label = esc_html__("File",'acf');
		$this->category = esc_html__("Content",'acf');
		$this->defaults = array(
			'save_format'	=>	'object',
			'library' 		=>	'all'
		);
		$this->l10n = array(
			'select'		=>	esc_html__("Select File",'acf'),
			'edit'			=>	esc_html__("Edit File",'acf'),
			'update'		=>	esc_html__("Update File",'acf'),
			'uploadedTo'	=>	esc_html__("uploaded to this post",'acf'),
		);
		...
		<ul class="hl clearfix">
			...
			<li>
				...
				<p>
					...
					<a class="acf-file-name" href="<?php echo esc_url($o['url']); ?>" target="_blank"><?php echo $o['name']; ?></a>
				</p>
				<p>
...
<tr class="field_option field_option_<?php echo esc_attr($this->name); ?>">
	...
	<td>
		...
		do_action('acf/create_field', array(
			...
			'layout'	=>	'horizontal',
			'choices' 	=>	array(
				'object'	=>	esc_html__("File Object",'acf'),
				'url'		=>	esc_html__("File URL",'acf'),
				'id'		=>	esc_html__("File ID",'acf')
			)
		));
	...
	<td>
		...
		do_action('acf/create_field', array(
			...
			'choices' 	=>	array(
				...
				'uploadedTo'	=>	esc_html__('Uploaded to post', 'acf')
			)
		));
