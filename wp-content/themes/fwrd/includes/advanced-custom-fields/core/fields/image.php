...
class acf_field_image extends acf_field
{
	...
	*/
	...
	function __construct()
	{
		// vars
		$this->name = 'image';
		$this->label = esc_html__("Image",'acf');
		...
		$this->l10n = array(
			'select'		=>	esc_html__("Select Image",'acf'),
			'edit'			=>	esc_html__("Edit Image",'acf'),
			'update'		=>	esc_html__("Update Image",'acf'),
...
<tr class="field_option field_option_<?php echo $this->name; ?>">
	...
	<td>
		...
		do_action('acf/create_field', array(
			...
			'layout'	=>	'horizontal',
			'choices'	=> array(
				'object'	=>	esc_html__("Image Object",'acf'),
				'url'		=>	esc_html__("Image URL",'acf'),
				'id'		=>	esc_html__("Image ID",'acf')
			)
		));
		?>
	</td>
