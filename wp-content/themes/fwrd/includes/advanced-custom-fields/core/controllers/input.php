	...
	*/
	...
	function input_admin_head()
	{
		...
		$l10n = apply_filters( 'acf/input/admin_l10n', array(
			'core' => array(
				'expand_details' => esc_html__("Expand Details",'acf'),
				'collapse_details' => esc_html__("Collapse Details",'acf')
			),
			'validation' => array(
				'error' => esc_html__("Validation Failed. One or more fields below are required.",'acf')
			)
		));
