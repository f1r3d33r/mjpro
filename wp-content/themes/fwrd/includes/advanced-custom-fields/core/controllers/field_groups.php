...
<div id="acf-col-right">
	...
	<div class="wp-box">
		<div class="inner">
			<h2><?php esc_html_e("Advanced Custom Fields",'acf'); ?> <?php echo $version; ?></h2>

			<h3><?php esc_html_e("Changelog",'acf'); ?></h3>
			<p><?php esc_html_e("See what's new in",'acf'); ?> <a href="<?php echo admin_url('edit.php?post_type=acf&info=changelog'); ?>"><?php esc_html_e("version",'acf'); ?> <?php echo $version; ?></a>
...
<div id="acf-about" class="acf-content">
	...
	<div class="acf-content-title">
		...
		<h2><?php esc_html_e("Thank you for updating to the latest version!",'acf'); ?> <br />ACF <?php echo $version; ?> <?php esc_html_e("is more polished and enjoyable than ever before. We hope you like it.",'acf'); ?></h2>
	</div>
	<!-- / acf-content-title -->
	...
	<div class="acf-content-body">
		<h2 class="nav-tab-wrapper">
			...
			<a class="acf-tab-toggle nav-tab nav-tab-active" href="<?php echo admin_url('edit.php?post_type=acf&info=download-add-ons'); ?>"><?php esc_html_e("Download Add-ons",'acf'); ?></a>
			<?php endif; ?>
		</h2>
...
<?php if( $tab == 'whats-new' ): 
		...
		<?php esc_html_e("Migrating your field types is easy, please",'acf'); ?> <a href="http://www.advancedcustomfields.com/docs/tutorials/creating-a-new-field-type/" target="_blank"><?php esc_html_e("follow this tutorial",'acf'); ?></a> <?php esc_html_e("to learn more.",'acf'); ?></p>
		
		<h4><?php esc_html_e("Actions &amp; Filters",'acf'); ?></h4>
		<p><?php esc_html_e("All actions & filters have received a major facelift to make customizing ACF even easier! Please",'acf'); ?> <a href="http://www.advancedcustomfields.com/resources/getting-started/migrating-from-v3-to-v4/" target="_blank"><?php esc_html_e("read this guide",'acf'); ?></a> <?php esc_html_e("to find the updated naming convention.",'acf'); ?></p>
		...
		<p><?php esc_html_e("Do to the sizable changes surounding Add-ons, field types and action/filters, your website may not operate correctly. It is important that you read the full",'acf'); ?> <a href="http://www.advancedcustomfields.com/resources/getting-started/migrating-from-v3-to-v4/" target="_blank"><?php esc_html_e("Migrating from v3 to v4",'acf'); ?></a> <?php esc_html_e("guide to view the full list of changes.",'acf'); ?></p>
		
		<div class="acf-alert acf-alert-error">
			<p><strong><?php esc_html_e("Really Important!",'acf'); ?></strong> <?php esc_html_e("If you updated the ACF plugin without prior knowledge of such changes, please roll back to the latest",'acf'); ?> <a href="http://wordpress.org/extend/plugins/advanced-custom-fields/developers/"><?php esc_html_e("version 3",'acf'); ?></a> <?php esc_html_e("of this plugin.",'acf'); ?></p>
		</div>
		
		<hr />
		
		<h3><?php esc_html_e("Thank You",'acf'); ?></h3>
		<p><?php wp_kses(__("A <strong>BIG</strong> thank you to everyone who has helped test the version 4 beta and for all the support I have received.",'acf'),iron_get_allowed_html()); ?></p>
...
<?php elseif( $tab == 'changelog' ): ?>
		...
		$items = wp_remote_retrieve_body(wp_remote_request( $path . 'readme.txt' ) );
		...
		?>
			<li><?php echo $item[0]; ?><?php if( isset($item[1]) ): ?><a href="http<?php echo $item[1]; ?>" target="_blank"><?php esc_html_e("Learn more",'acf'); ?></a><?php endif; ?></li>
		<?php endforeach; ?>
		</ul>
...
<?php elseif( $tab == 'download-add-ons' ): ?>
		...
		<ol>
			...
			<li><?php esc_html_e("Navigate to",'acf'); ?> <a target="_blank" href="<?php echo admin_url('plugin-install.php?tab=upload'); ?>"><?php esc_html_e("Plugins > Add New > Upload",'acf'); ?></a></li>
